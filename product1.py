...
if isDisplayed == True :
    ...
    order_num = driver.find_element(By.CSS_SELECTOR, '#__next > div > div > div.css-1lzf9gf > div.orderNum > ul > li:nth-child(2) > span').text
    print('product1 - 옵션상품 주문 pass')
    print('주문번호 : '+order_num)
else :
    print('product1 - 옵션상품 주문 fail')
